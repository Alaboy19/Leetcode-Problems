...
You are given two integer array position and speed, both of length n, where position[i] is the position of the ith car and speed[i] is the speed 
...
def carFleet(self, target: int, position: List[int], speed: List[int]) -> int:
        ...
        for pos, speeds in pos_speed:
            time_to_reach = (target - pos) / speeds
